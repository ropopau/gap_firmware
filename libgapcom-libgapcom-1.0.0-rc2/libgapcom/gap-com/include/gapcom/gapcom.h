 ...
 * about encoding/decoding message payloads, not about the medium through
 * which bytes will be transported.
 *
...
/**
 * @brief Maximum length (in bytes) of version string. See proto/gap.options.
 */
 ...
 * communication channel is currently being used; UART in our case.
 *
 * @param handle Handle to the libgapcom session

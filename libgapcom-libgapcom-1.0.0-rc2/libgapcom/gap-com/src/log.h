...
/* gap_config.h is an OPTIONAL header meant to embark symbols usually
 * generated through the CMake build system, like GAP_COM_EOL. In order
 * to allow a simpler build system to take over gapcom code, like the
 * STM32CubeIDE UNIX Makefiles based build system, we allow defining
 * such symbols in gap_config.h
 */
